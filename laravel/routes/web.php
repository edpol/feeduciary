...
Route::get('/edit/{advisor}',          'AdvisorsController@edit')->middleware('auth'); 
Route::get('/update/{advisor}',        'AdvisorsController@update')->middleware('auth'); 
...
Route::get('/update',                  'Auth\LoginController@update')->middleware('auth');

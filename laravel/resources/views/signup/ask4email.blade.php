...
@endif
                            ...
                            <div class="modal-body text-left bg-light text-dark">
                                <div class="m-3">
                                    <div class="form-group my-3 my-md-2 row">
                                        ...
                                        <input class="form-control col-md-9 col-12" type="email" id="email" name="email" value="{{ $email }}" tabindex=1 autofocus />
                                    </div>
                                    <div class="form-group mb-2 mb-md-3 row">
                                        <label class="col-md-2 pt-2" for="name">Name:</label>
                                        <input class="form-control col-md-9 col-12" type="text"  id="name"  name="name"  value="{{ $name }}" tabindex=2 />
                                    </div>
 @include('signup.debug')
                                    <div class="modal-footer row">
                                        ...
                                        @endguest
                                        <button type="button" tabindex=4 class="btn btn-default mb-1 col-md-2 col-12 mr-0" data-dismiss="modal">Close</button>

                                        <button type="submit" tabindex=3 class="btn btn-primary mb-1 col-md-2 col-12 mr-0">Save</button>
                                    </div>
                                </div>
                            </div>

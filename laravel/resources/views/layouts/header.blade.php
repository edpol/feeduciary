    ...
    <div class="container">
        <div class="intro-message">
            ...
            if (auth()->check() || $verified===true)
                ...
                $url = '/signup/store');
            ?>
            <form id="frmContact" method="get" action="{{url($url)}}">
                {{ csrf_field() }}

                <div class="bluebox text-left" style="margin:0 auto; width:40%; min-width:280px;">
                    <h4 class="mb-3 text-center font18"> Please enter investment amount to calculate
                        fees</h4>
                    <div class="form-group">
                        <label for="amount" class="d-none d-sm-block">Amount*</label>
                        <input type="text" class="form-control comma" id="amount" name="amount"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <a href="https://twitter.com/feeduciary" target="_blank">
                                <img align="right" src="{{ asset('/images/social-twitter.png') }}"
                                     alt="feeduciary on twitter"/>
                            </a>
                        </div>
                    </div>
